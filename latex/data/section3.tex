...
The following section is a description of the LHC and CERN accelerator complex, a more detailed description can be found in~\cite{Breskin:1244506} and~\cite{LHCmachine}.

\begin{figure}[!hbt]
    \vspace*{-0.5cm}
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/LHC_schematic.jpg}
...
The LHC provides beams for several experiments located along its beam line, though we will only concern ourselves with the four highest profile experiments (Fig.~\ref{fig:LHC_schematic}):
\begin{itemize}
...
\begin{sidewaysfigure}[!hbt]
    ...
    \begin{subfigure}[t]{0.4655\textwidth}
        \includegraphics[width=\textwidth]{\figpath/Chapter3/CERN's-accelerator-complex2013.jpg}
        \label{fig:CERN_accelerator_complex}
    \end{subfigure}
    \begin{subfigure}[t]{0.4655\textwidth}
        \includegraphics[width=\textwidth]{\figpath/Chapter3/lhc-pho-1993-008.png}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/lhc-pho-1997-060.png}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/lhc-pho-1998-299.jpg}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/int_lumi_cumulative_pp_2.pdf}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/int_lumi_per_day_cumulative_pp_2012.pdf}
...
The CMS experiment is one of two general purpose detectors at the LHC tasked with a wide variety of physics analyses.
The goals of the physics program range from precision Standard Model measurements to the search for physics beyond the Standard Model and even includes a hugely successful heavy ion program.
The detector itself is located 100\unit{m} underground near Cessy, France on the opposite side of the LHC from the main CERN site in Meyrin (see figure~\ref{fig:LHC_schematic}).
It was largely built on the surface and then lowered into the collision cavern in 15 pieces, which then had to be assembled. %painstakingly
...
The following sections will describe each of the sub-detectors and its properties~\cite{Chatrchyan:2008aa}.

\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/cms_160312_02.png}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/CMS_slice.png}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/Figures_T_Coordinate.png}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/CMS_tracker.pdf}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/ECAL_transverse_section.pdf}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/HCAL_subdet.pdf}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/HCAL_tower_segmentation.pdf}
...
One of the namesake features of the CMS apparatus is a superconducting solenoid of 6\unit{m} internal diameter, providing a magnetic field of 3.8\unit{T}.
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/CMS_solenoid.jpg}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/CMS_muon_system.pdf}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/CMS_muon_system_DT}
...
A trigger system is implemented to reduce this rate and keep only the most interesting, and hopefully relevant, events.
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath/Chapter3/L1_architecture.png}
